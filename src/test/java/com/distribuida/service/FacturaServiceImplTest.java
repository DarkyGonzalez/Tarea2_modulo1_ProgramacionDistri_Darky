...
public class FacturaServiceImplTest {
    ...
    public void findOneExistente (){
        ...
        assertEquals("FAC-0097", factura1.orElse(null).getNumFactura());
    ...
    public void save(){
        ...
        assertEquals("FAC-0097", resultado.getNumFactura());
    }
    ...
    public void updateExistente(){
        ...
        facturaActualizada.setNumFactura("FAC-0099");
        facturaActualizada.setFecha(new Date());
        facturaActualizada.setTotalNeto(150.99);
        facturaActualizada.setIva(22.99);
        facturaActualizada.setTotal(175.99);
        ...
        assertNotNull(resultado);
        assertEquals("FAC-0099",resultado.getNumFactura());
